...
def generate_dataset(niid, balance, partition, args):
    ...
    dir_path = f"MNIST_{args.partition}_{args.alpha if args.partition == 'dir' else args.class_per_client}_{args.balance}_{args.num_users}/"
    ...
    trainset = torchvision.datasets.MNIST(
        root="./MNIST/rawdata/", train=True, download=True, transform=transform
    )
