...
nohup python -u main.py -algo FedProto -addTGP 0 -data Cifar10_dir_0.3_imbalance_40 -gr 200 -lbs 256 -nc 40 -optimizer SGD -lr 0.06 -wd 0.00001 -momentum 0.5 -lam 2  -ls 10 -m HtFE8 -drawtsne 1 -drawround 10 > ./logs/Cifar10/Cifar10_dir_0.3_imbalance_40/epochs_10/SGD_lr_006_wd_1e-5_lam_2_momentum_0.5_batch_256_FedProto.out 2>&1 &
