...
nohup python -u main.py -algo FedProto -addTGP 0 -data FashionMNIST_dir_0.3_imbalance_40 -gr 150 -nc 40 -lr 0.03 -ls 10 -lam 2 -m HCNNs8 > ./logs/FashionMNIST/FashionMNIST_dir_0.3_imbalance_40/epochs_10/lam_2_FedProto.out 2>&1 &

# nohup python -u main.py -algo FedSAE -addTGP 0 -gamma 1.0 -data FashionMNIST_dir_0.3_imbalance_40 -gr 150 -nc 40 -lr 0.03 -ls 10 -lam 2 -test_useglclassifier 1 -SAEbeta 1 -m HCNNs8 -mart 1000 -mixclassifier 0 > ./logs/FashionMNIST/FashionMNIST_dir_0.3_imbalance_40/epochs_10/lam_2_FedSAE_noTGP_gl_use_clients_gamma_1.0_buffer=1.0.out 2>&1 &
