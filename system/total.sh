nohup python -u main.py -algo FedTGP -data Cifar10_dir_0.3_imbalance_40 -gr 500 -nc 40 -lr 0.01 -ls 10 -lam 0.1 -m HtFE8 > ./logs/Cifar10/Cifar10_dir_0.3_imbalance_40/epochs_10/lr_001_lamda_0.1_FedTGP.out 2>&1 &
