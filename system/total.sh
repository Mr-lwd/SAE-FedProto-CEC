# nohup python -u main.py -algo FedTGP -data Cifar10_dir_0.3_imbalance_40 -gr 200 -nc 40 -lr 0.0001 -ls 10 -lam 1 -m HtFE8 > ./logs/Cifar10/Cifar10_dir_0.3_imbalance_40/epochs_10/Adam_lr_1e-4_lamda_1_FedTGP.out 2>&1 &
...
# nohup python -u main.py -algo FedProto -addTGP 0 -data Cifar10_dir_0.3_imbalance_40 -gr 200 -lbs 256 -nc 40 -lr 0.0002 -ls 10 -lam 1 -m HtFE8 -drawtsne 1 -drawround 10 > ./logs/Cifar10/Cifar10_dir_0.3_imbalance_40/epochs_10/AdamW_lr_2e-4_wd_1e-4_lam_1_batch_256_FedProto.out 2>&1 &

nohup python -u main.py -algo FedProto -addTGP 0 -data Cifar10_dir_0.3_imbalance_40 -gr 200 -lbs 256 -nc 40 -lr 0.06 -ls 10 -lam 1 -m HtFE8 -drawtsne 1 -drawround 10 > ./logs/Cifar10/Cifar10_dir_0.3_imbalance_40/epochs_10/SGD_lr_006_lam_1_momentum_0.5_batch_256_FedProto.out 2>&1 &