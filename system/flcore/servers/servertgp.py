    ...
    def update_Gen(self):
        ...
        for e in range(self.server_epochs):
            ...
            for proto, y in proto_loader:
                # y = torch.tensor(y).to(self.device, dtype=torch.int64)
                ...
                print("features_square.shape:", features_square.shape)
                print("centers_square.T.shape:", centers_square.T.shape)
                print("features_into_centers.shape:", features_into_centers.shape)
