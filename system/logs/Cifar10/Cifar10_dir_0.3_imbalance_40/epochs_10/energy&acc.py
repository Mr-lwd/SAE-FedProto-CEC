...
log_files = [
    "./lam_2_FedProto.out",
    # "./lam_2_FedSAE_noTGP_gl_use_clients_gamma_0.5_buffer=1.0.out",
    # "./lam_2_FedSAE_noTGP_gl_use_clients_gamma_0.7_buffer=1.0.out",
    "./lam_2_FedSAE_noTGP_gl_use_clients_gamma_1.0_buffer=1.0.out",
    "./gaussian_lamda_2_FedSAE_noTGP_gamma_1.0_buffer=1.0.out"
]
time_model_configs = [
    {
